    ...
    >
      <div className={`bg-primary ${styles.flexCenter} ${styles.paddingX}`}>
        <div className={`${styles.boxWidth}`}>
          <h1 className="flex-1 font-poppins font-semibold ss:text-[55px] xsm:text-[45px] text-[37px] text-white ss:leading-[80px] leading-[49px]">
            Achievements
          </h1>
        </div>
      </div>
...
const AchievementCard = (props) => {
  return (
    <div className="achievement-card flex-shrink-0 flex flex-col md:w-[400px] xs:w-[320px] xsm:w-[290px] w-[250px] justify-around px-3 xs:px-6 py-4 rounded-[20px] md:mr-10 mr-6 my-5 transition-colors duration-300 transform border hover:border-transparent dark:border-gray-700 dark:hover:border-transparent">
      <img
        src={props.icon}
        alt={props.event}
